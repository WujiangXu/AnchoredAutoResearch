...
## Code review
- After EXECUTE completes, the code review tool reviews the changed code automatically
- Review summary written to RSD under EXECUTE section
- Human reads review summary instead of reviewing code directly
...
## Skill architecture
- .agents/skills/research/SKILL.md — main routing + common rules
- .agents/skills/research/references/ — symlink to shared protocol files
...
## Dual-agent support
This project also supports Claude Code — see CLAUDE.md.
